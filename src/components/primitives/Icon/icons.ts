// Smart Noter — Fluent-style icon set (inline SVG paths).
// Ported from handoff/smart-noter/project/icons.jsx.
export const ICONS = {
  // nav
  ...
  share:
    'M18 8a3 3 0 1 0-3-3 3 3 0 0 0 .04.5l-6.1 3.55a3 3 0 1 0 0 4.9l6.1 3.55A3.06 3.06 0 0 0 15 18a3 3 0 1 0 3-3 3.06 3.06 0 0 0-2.04.81l-6.1-3.55a3.07 3.07 0 0 0 0-1.52l6.1-3.55A3 3 0 0 0 18 8z',
  edit: 'M4 20h4l11-11-4-4L4 16zM14 6l4 4',
  trash:
    'M5 7h14M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2M6 7l1 13a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1l1-13',
  ...
  megaphone:
    'M3 11v2a1 1 0 0 0 1 1h2l5 4V6L6 10H4a1 1 0 0 0-1 1zM15 9a3 3 0 0 1 0 6M19 6a7 7 0 0 1 0 12',
  ...
  headphones:
    'M4 14v3a2 2 0 0 0 2 2h1v-7H6a2 2 0 0 0-2 2zM20 14v3a2 2 0 0 1-2 2h-1v-7h1a2 2 0 0 1 2 2zM4 14a8 8 0 0 1 16 0',
...
export const FILLED_ICONS: ReadonlySet<IconName> = new Set([
  'record',
  'play',
  'stop',
  'pause',
